// src/app/[locale]/(protected)/communities/[name]/[postId]/[commentId]/page.tsx
"use client";

import { IsolatedCommentView } from "@/app/[locale]/(protected)/(components)/comments/isolated-comment-view";
import { useParams } from "next/navigation";

export default function CommunityIsolatedCommentPage() {
    ...
    <div className="flex w-full min-h-full py-6 justify-center">
      <div className="flex flex-col w-full px-4 sm:px-6">
        <IsolatedCommentView
          postId={postId}
          commentId={commentId}
          backUrl={`/${locale}/communities/${encodeURIComponent(name)}/${postId}`}
        />
      </div>
    </div>
  );
