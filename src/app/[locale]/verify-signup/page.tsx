// src/app/[locale]/verify-signup/page.tsx
...
import { VerifySignupResult } from "./(components)/verify-signup-result";
...
export default async function VerifySignupPage({
  ...
  return (
    <div className="min-h-[100dvh] bg-background flex flex-col justify-center items-center px-4 sm:px-6 py-6 sm:py-8 overflow-hidden">
      <VerifySignupResult status={status ?? "invalid"} locale={locale} />
